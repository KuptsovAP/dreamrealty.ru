...
$APPLICATION->SetTitle("КУПИТЬ КВАРТИРУ С НАМИ");
?>
...
<?$APPLICATION->IncludeComponent(
    ...
    Array(
        ...
        "AREA_FILE_SUFFIX" => "inc",
        "EDIT_TEMPLATE" => "",
        "PATH" => "/include/catalog-sections.php"
    )
);?>
        ...
        <div class="wrapper">
            <div class="section__content-changer g-flex-column">
                <div class="section__content-tabs -m-left g-flex-justify-center g-flex-align-center fit-content center --mgb0">
                    <div class="section__content-tab active">Вторичка</div>
                    <div class="section__content-tab">Новостройка</div>
                    <div class="section__content-tab">Любой вариант</div>
                </div>
...
$APPLICATION->IncludeComponent(
    ...
    Array(
        ...
        "ADV_PAGE" => "/buy/advantages-new/",
        "ADVANTAGES_IDS" => $advantagesIds,
        "SECTION_TITLE" => '<span class="--green">Преимущества</span> покупки квартиры с нами',
        "MIN_TEXT_CLASS" => "N",
    )
);?>
