<form class="g-flex-wrap g-flex-between g-flex-align-center" style="background: white;padding-bottom: 0;">
    ...
    <label class="inputCheckbox w66 w100-xs">
        ...
        <span>Нажимая на кнопку "Стать партнером", <a href="/policy/">вы даете согласие на обработку персональных данных</a> и согласны с Правилами партнерской программы</span>
    </label>
</form>