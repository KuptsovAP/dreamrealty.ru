<form class="g-flex-wrap g-flex-between g-flex-align-center" style="background: white;padding-bottom: 0;">
    ...
    <label>
        <select name="status" data-placeholder="Сфера деятельности*" id="selectStatus" required>
            <option value="">&nbsp;</option>
        ...
        <span class="status" style="position: relative;display:none" id="writeStatus">
                            <input type="text" class="status" placeholder="Статус*" required="">
                            <button type="button" id="hideStatus" style="font-weight: bold;position: absolute;top: -2px;right: 25px;font-size: 18px;">&times;</button>
                        </span>
    </label>
    <label></label>
    <label>
    ...
    <label class="inputCheckbox w66 w100-xs">
        ...
        <span>Нажимая на кнопку "Стать партнером", <a target="_blank" href="/policy/">вы даете согласие на обработку персональных данных</a> и согласны с Правилами партнерской программы</span>
    </label>
</form>