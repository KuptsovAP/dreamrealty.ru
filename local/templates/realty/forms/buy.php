<section class="section how-it-works --pdb0" id="formBlockSmooth">
            <div class="wrapper">
                <div class="section__content-changer g-flex-column">
                    <div class="section__content-tabs -m-left g-flex-justify-center g-flex-align-center fit-content center --mgb0">
                    ...
                    <div class="section__content-slider slider">
                        <div class="section__content-slide">
                            <form class="g-flex-wrap g-flex-between g-flex-align-center --mgt30 --bottom-fix --key">
                                ...
                                <label>
                                    <input type="text" name="UF_NAME" placeholder="Имя*" required>
                                </label>
                                <label>
                                ...
                                <label>
                                    <select multiple="multiple" data-placeholder="Район покупки*" name="UF_AREA" required>
                                        <option value="">&nbsp;</option>
                                        <optgroup label="ЦАО">
                                            <option>Арбат</option>
                                ...
                                <label>
                                    <input type="text" required placeholder="Бюджет, кол-во комнат*" name="UF_BUDROOMS">
                                </label>
                        ...
                        <div class="section__content-slide">
                            <form class="g-flex-wrap g-flex-between g-flex-align-center --mgt30 --bottom-fix --key">
                                ...
                                <button type="submit" class="btn --green">Заказать консультацию</button>
                                <label>
                                    <select data-placeholder="Цель покупки*" name="UF_GOAL" required>
                                        <option value="">&nbsp;</option>
                                        <option>жить</option>
                                ...
                                <label>
                                    <select data-placeholder="Бюджет*"  requred name="UF_BUD">
                                        <option value="">&nbsp;</option>
                        ...
                        <div class="section__content-slide">
                            <form class="g-flex-wrap g-flex-between g-flex-align-center --mgt30 --bottom-fix --key">
                                <h3>Выбрать <span class="--green">агента</span></h3>
                                <label>
                                    <input type="text" placeholder="Имя*" name="UF_NAME" required>
                                </label>
                                <label>
                                ...
                                <label>
                                    <select data-placeholder="Район покупки*" name="UF_AREA" required>
                                        <option value="">&nbsp;</option>
                                        <optgroup label="ЦАО">
                                            <option>Арбат</option>
                                            <option>Басманный</option>
                        ...
                        <div class="section__content-slide">
                            <h3 class="--mgb60">Ипотечный брокер</h3>
                            <div class="section__content-advantages g-flex-wrap g-flex-between g-flex-align-start">
                                <div class="section__content-advantage g-flex-column g-flex-align-start">
                                    <img loading="lazy" src="./assets/svg/ErrorFind.svg" alt="">
                                    <p>Проверит вашу кредитную историю</p>
                                </div>
                                <div class="section__content-advantage g-flex-column g-flex-align-start">
                                    <img loading="lazy" src="./assets/svg/DoneCircle.svg" alt="">
                                    <p>Оценит шансы на одобрение ипотеки</p>
                                </div>
                                <div class="section__content-advantage g-flex-column g-flex-align-start">
                                    <img loading="lazy" src="./assets/svg/RoubleHands.svg" alt="">
                                    <p>Подберет лучшие ипотечные программы с учетом вашей ситуации</p>
                                </div>
                                <div class="section__content-advantage g-flex-column g-flex-align-start">
                                    <img loading="lazy" src="./assets/svg/TwoLists.svg" alt="">
                                    <p>Поможет собрать и подать пакет документов в несколько банков</p>
                                </div>
                                <div class="section__content-advantage g-flex-column g-flex-align-start">
                                    <img loading="lazy" src="./assets/svg/JobInterview.svg" alt="">
                                    <p>Проведет переговоры с банком по снижению процентной ставки</p>
                                </div>
                                <div class="section__content-advantage g-flex-column g-flex-align-start">
                                    <img loading="lazy" src="./assets/svg/Calculator.svg" alt="">
                                    <p>Оптимизирует расходы на ипотеку за счет стоимости страховки</p>
                                </div>
                                <div class="section__content-advantage g-flex-column g-flex-align-start">
                                    <img loading="lazy" src="./assets/svg/RoubleHouse.svg" alt="">
                                    <p>Закажет оценку приобретаемого объекта</p>
                                </div>
                                <div class="section__content-advantage g-flex-column g-flex-align-start">
                                    <img loading="lazy" src="./assets/svg/Bank.svg" alt="">
                                    <p>Присутствует на подписании документов в банке</p>
                                </div>
                                <div class="section__content-advantage g-flex-column g-flex-align-start">
                                    <img loading="lazy" src="./assets/svg/WomanQuestions.svg" alt="">
                                    <p>Ответит на все ваши вопросы в любом удобном формате</p>
                                </div>
                            </div>
                            <form class="g-flex-wrap g-flex-between g-flex-align-center --mgt30 --bottom-fix --key">
                                ...
                                <button type="submit" class="btn --green">Заказать консультацию</button>
                                <label>
                                    <select data-placeholder="тип услуги*" name="UF_SERVICE" required>
                                        <option value="">&nbsp;</option>
