...
<h3>Заказать <span class="--<? $APPLICATION->ShowProperty("color") ?>">оценку</span> квартиры прямо сейчас</h3>
    <label>
    ...
    <button type="submit" class="btn --<? $APPLICATION->ShowProperty("color") ?>">Заказать оценку</button>
    <label>
