...
<h3>Заказать <span class="--<? $APPLICATION->ShowProperty("color") ?>">фотосъемку</span> квартиры прямо сейчас</h3>
    <label>
    ...
    <button type="submit" class="btn --<? $APPLICATION->ShowProperty("color") ?>">Заказать фотосъемку</button>
    <label>
    ...
    <label>
        <input type="text" name="UF_BUDROOMS" placeholder="Адрес, кол-во комнат">
    </label>
    <label class="inputCheckbox">
        <input type="checkbox" required checked>
        <span>Нажимая на кнопку "Заказать фотосъемку", <a target="_blank" href="/policy/">вы даете согласие на обработку персональных данных</a></span>
    </label>
</form>