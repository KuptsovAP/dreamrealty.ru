<div class="advantages-pop-up pop-up g-flex-column --pdb90" id="feedbackPop2">
                    ...
                    <div class="section__content-slider slider">
                        <div class="section__content-slide">
                            <form class="g-flex-wrap g-flex-between g-flex-align-center --mgt30 --bottom-fix --key">
                                ...
                                <label>
                                    <input type="text" required name="UF_BUDROOMS" placeholder="Бюджет, кол-во комнат*">
                                </label>
                        ...
                        <div class="section__content-slide">
                            <form class="g-flex-wrap g-flex-between g-flex-align-center --mgt30 --bottom-fix --key">
                                ...
                                <label>
                                    <select data-placeholder="Бюджет*" required name="UF_BUD">
                                        <option value="">&nbsp;</option>
                        ...
                        <div class="section__content-slide">
                            <form class="g-flex-wrap g-flex-between g-flex-align-center --mgt30 --bottom-fix --key">
                                <h3>Выбрать <span class="--<? $APPLICATION->ShowProperty("color") ?>">агента</span></h3>
                                <label>
                                    <input type="text" placeholder="Имя*" name="UF_NAME" required>
                                </label>
                                <label>
