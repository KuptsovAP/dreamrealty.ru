...
$APPLICATION->SetTitle("ПРЕИМУЩЕСТВА ОДОБРЕНИЯ ИПОТЕКИ С НАМИ");
?>
    ...
    <section class="section how-it-works --pdb0">
        <div class="wrapper">
            ...
            <div class="section__content-changer g-flex-column">
                <div class="section__content-tabs top g-flex-justify-center g-flex-align-center fit-content center --mgb40">
    ...
    <section class="section how-it-works">
        <div class="wrapper">
            <h2 class="section__title --mgb20">Хотите узнать, <span class="--pink">как мы будем одобрять</span> вам ипотеку?</h2>
