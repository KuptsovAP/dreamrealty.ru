                ...
                <div class="object-images">
                    ...
                    <div class="btn-groups g-flex-column-xs">
                        ...
                        <div class="btn --agent w100-xs --mg0-xs --mgt20-xs">
                            <div class="view">
                                <img src="<?=$content['agent']['avatar']?>" alt="">
                                <span class="name">Агент:<br><strong><?=$content['agent']['name']?></strong></span>
                            </div>
                            <div class="info">
                                <div>тел: <?=$content['agent']['phone']?></div>
                                <div>e-mail: <?=$content['agent']['email']?></div>
                            </div>
                        </div>
                    </div>
                </div>
