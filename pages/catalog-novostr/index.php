                ...
                <?php foreach ($idpodcasts as $video) : ?>
                    ...
                    while ($el = $rsData->fetch()) :?>
                        ...
                        <div class="section__podcast g-flex-column" style="background-image: url(<?= $URL ?>);">
                            ...
                            <audio data-status="stopped" controls src="<?= $audio ?>"
                                   class="section__podcast_audio-tag">
...
<section class="section advantage-cards relative grayHalfBG --pdb60">
    <div class="wrapper">
        <h2 class="section__title --mgb60"><span class="--green">Преимущества</span> покупки квартиры в новостройке с
            нами</h2>
        <div class="section__advantage-cards_slider slider --min-text">
            <div class="section__advantage-cards_slide">
                <a href="/buy/advantages-new/#advant_pop-up1"
                   class="section__advantage-card relative g-flex-column g-flex-justify-end"
                   style="background-image: url(/html/assets/img/illustrations/green/01.1.svg);">
                    <div class="g-flex-align-center g-flex-justify-center"><p><span style="margin: 0" class="--green">Работаем на вас</span>,
                            а не на застройщика</p></div>
                    <span class="num">1</span>
                </a>
            </div>
            <div class="section__advantage-cards_slide">
                <a href="/buy/advantages-new/#advant_pop-up2"
                   class="section__advantage-card relative g-flex-column g-flex-justify-end"
                   style="background-image: url(/html/assets/img/illustrations/green/02.svg);">
                    <div class="g-flex-align-center g-flex-justify-center"><p>Оцениваем <span style="margin: 0"
                                                                                              class="--green">инвестиционный потенциал</span>
                        </p></div>
                    <span class="num">2</span>
                </a>
            </div>
            <div class="section__advantage-cards_slide">
                <a href="/buy/advantages-new/#advant_pop-up3"
                   class="section__advantage-card relative g-flex-column g-flex-justify-end"
                   style="background-image: url(/html/assets/img/illustrations/green/03.1.svg);">
                    <div class="g-flex-align-center g-flex-justify-center"><p>Работаем <span style="margin: 0"
                                                                                             class="--green">“под ключ”</span>
                        </p></div>
                    <span class="num">3</span>
                </a>
            </div>
            <div class="section__advantage-cards_slide">
                <a href="/buy/advantages-new/#advant_pop-up4"
                   class="section__advantage-card relative g-flex-column g-flex-justify-end"
                   style="background-image: url(/html/assets/img/illustrations/green/04.svg);">
                    <div class="g-flex-align-center g-flex-justify-center"><p>Владеем <span style="margin: 0"
                                                                                            class="--green">инсайдерской информацией</span>
                        </p></div>
                    <span class="num">4</span>
                </a>
            </div>
            <div class="section__advantage-cards_slide">
                <a href="/buy/advantages-new/#advant_pop-up5"
                   class="section__advantage-card relative g-flex-column g-flex-justify-end"
                   style="background-image: url(/html/assets/img/illustrations/green/05.1.svg);">
                    <div class="g-flex-align-center g-flex-justify-center"><p>Предлагаем <span style="margin: 0"
                                                                                               class="--green">100% рынка новостроек</span>
                        </p></div>
                    <span class="num">5</span>
                </a>
            </div>
            <div class="section__advantage-cards_slide">
                <a href="/buy/advantages-new/#advant_pop-up6"
                   class="section__advantage-card relative g-flex-column g-flex-justify-end"
                   style="background-image: url(/html/assets/img/illustrations/green/06.svg);">
                    <div class="g-flex-align-center g-flex-justify-center"><p><span style="margin: 0" class="--green">Помогаем сформировать</span>
                            бюджет на покупку</p></div>
                    <span class="num">6</span>
                </a>
            </div>
            <div class="section__advantage-cards_slide">
                <a href="/buy/advantages-new/#advant_pop-up7"
                   class="section__advantage-card relative g-flex-column g-flex-justify-end"
                   style="background-image: url(/html/assets/img/illustrations/green/07.svg);">
                    <div class="g-flex-align-center g-flex-justify-center"><p><span style="margin: 0" class="--green">Официальный отчет о проверке</span>
                            объекта и застройщика</p></div>
                    <span class="num">7</span>
                </a>
            </div>
            <div class="section__advantage-cards_slide">
                <a href="/buy/advantages-new/#advant_pop-up8"
                   class="section__advantage-card relative g-flex-column g-flex-justify-end"
                   style="background-image: url(/html/assets/img/illustrations/green/08.svg);">
                    <div class="g-flex-align-center g-flex-justify-center"><p><span style="margin: 0" class="--green">Свой YouTube канал</span>
                            о новостройках</p></div>
