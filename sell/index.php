...
$APPLICATION->SetTitle("ПРОДАТЬ КВАРТИРУ С НАМИ");
?>
...
/*
    ...
    $APPLICATION->IncludeComponent(
        ...
        Array(
            ...
            "ADV_PAGE" => "/sell/advantages.php",
            "ADVANTAGES_IDS" => $advantagesIds,
            "SECTION_TITLE" => '<span class="--red">Преимущества</span> продажи квартиры с нами',
            "MIN_TEXT_CLASS" => "Y",
        )
    );
*/
...
$APPLICATION->IncludeComponent(
    ...
    array(
        ...
        "SORT_BY2" => "NAME",
        "SORT_ORDER2" => "ASC",
        "TITLE" => '<span class="--red">Преимущества</span> продажи квартиры с нами',
