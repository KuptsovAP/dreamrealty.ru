<section class="section__content-changer g-flex-column --mgt40 --pdb40">
    <div class="section__content-tabs -m-left top g-flex-between g-flex-align-center center g-flex-wrap --mgb0">
        ...
        <a href="#description" class="js__smoothScroll section__content-tab">Описание объекта</a>
...
<section class="section object-informations --pdt40 --pdb40" id="mainInfo">
    <div class="wrapper">
        <div class="object-info">
            ...
            <div class="rc_name"><strong><?= $arProperties['COMPLEX']['VALUE']; ?></strong></div>
                ...
                <div class="section__content-slide --table">
                    <div class="table">
                        <div class="tr">
                            ...
                            <div class="td"><?= $arProperties['SQUARE_ALL']['VALUE']; ?> кв.м</div>
                        </div>
                        <div class="tr">
                            <div class="td">Жилая площадь</div>
                            <div class="td"><?= $arProperties['SQUARE_LIVING']['VALUE']; ?> кв.м</div>
                        </div>
                        <div class="tr">
                        ...
                        <div class="tr">
                            ...
                            <div class="td"><?= $arProperties['PLANTYPE']['VALUE']; ?></div>
                        </div>
                        <div class="tr">
                        ...
                        <div class="tr">
                            ...
                            <div class="td"><?= $arProperties['BATHROOMS']['VALUE']; ?> м</div>
                        </div>
                        <div class="tr">
                            <div class="td">Балкон/Лоджия</div>
                            <div class="td"><?= $arProperties['BALCONY']['VALUE']; ?> балкон</div>
                        </div>
                        <div class="tr">
                            <div class="td">Вид из окон</div>
                            <div class="td"><?= $arProperties['VIEWS_VINDOW']['VALUE']; ?></div>
                        </div>
                        <div class="tr">
                            <div class="td">Этаж/этажность</div>
                            <div class="td"><?= $arProperties['FLOOR']['VALUE']; ?></div>
                        </div>
                        <div class="tr">
                ...
                <div class="section__content-slide --table">
                    <div class="table">
                        <div class="tr">
                            ...
                            <div class="td"><?= $arProperties['RENOVATION']['VALUE']; ?></div>
                        </div>
                        <div class="tr">
                            <div class="td">Мебель</div>
                            <div class="td"><?= ($arProperties['FURNITURE']['VALUE']) ? "да" : "нет" ?></div>
                        </div>
                        <div class="tr">
                            <div class="td">Техника</div>
                            <div class="td"><?= ($arProperties['TECH']['VALUE']) ? "да" : "нет" ?></div>
                        </div>
                        <div class="tr">
                            <div class="td">Кондиционирование</div>
                            <div class="td"><?= ($arProperties['CLIMATIC']['VALUE']) ? "да" : "нет" ?></div>
                        </div>
                        <div class="tr">
                            <div class="td">Мусоропровод</div>
                            <div class="td"><?= ($arProperties['GARBAGE']['VALUE']) ? "да" : "нет" ?></div>
                        </div>
                        <div class="tr">
                            <div class="td">Лифт</div>
                            <div class="td"><?= $arProperties['ELEVATOR']['VALUE'] ?></div>
                        </div>
                        <div class="tr">
                            <div class="td">Парковка</div>
                            <div class="td"><?= $arProperties['PARKING']['VALUE'] ?></div>
                        </div>
                        <div class="tr">
                            <div class="td">Огороженная территория</div>
                            <div class="td"><?= $arProperties['SELF_AREA']['VALUE']; ?></div>
                        </div>
                        <div class="tr">
                            <div class="td">Охрана</div>
                            <div class="td"><?= $arProperties['GUARD']['VALUE']; ?></div>
                        </div>
                        <div class="tr">
                            <div class="td">Видеонаблюдение</div>
                            <div class="td"><?= $arProperties['VODEOCAM']['VALUE'] ?></div>
                        </div>
                        <div class="tr">
                            <div class="td">Консьерж</div>
                            <div class="td"><?= $arProperties['CONCIERGE']['VALUE'] ?></div>
                        </div>
                        <div class="tr">
                            <div class="td">Домофон</div>
                            <div class="td"><?= $arProperties['INTERCOM']['VALUE']; ?></div>
                        </div>
                        <div class="tr">
                            <div class="td">Статус сделки</div>
                            <div class="td"><?= $arProperties['TYPE_CONTRACT']['VALUE'] ?></div>
                        </div>
                        <div class="tr">
                            <div class="td">Основание прав собственности</div>
                            <div class="td"><?= $arProperties['GARANT']['VALUE'] ?></div>
                        </div>
                        <div class="tr">
                            <div class="td">Год вступления</div>
                            <div class="td"><?= $arProperties['YEAR_OWN']['VALUE'] ?></div>
                        </div>
                        <div class="tr">
                            <div class="td">Кол-во собственников</div>
                            <div class="td"><?= $arProperties['AMOUNT_OWN']['VALUE'] ?></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="object-images">
            ...
            <div class="btn-groups g-flex-column-xs">
                <div class="btn-group w100-xs">
                    ...
                    <button type="submit" class="btn w100-xs --<? $APPLICATION->ShowProperty("color") ?>"><?= number_format($price, 0, '', ' '); ?> ₽
                    </button>
                ...
                <?php if ($arProperties['AGENT']['VALUE']) { ?>
                    <div class="btn --agent w100-xs --mg0-xs --mgt20-xs">
                        <div class="view">
                            <img src="<?= $arAgentAvatar['src']; ?>" alt="">
                            <span class="name">Агент:<br><strong><?= $arAgentFields['NAME']; ?></strong></span>
                        </div>
                        <div class="info">
                            <div>тел: <?= $arAgentProperties['PHONE']['VALUE']; ?></div>
                            <div>e-mail: <?= $arAgentProperties['EMAIL']['VALUE']; ?></div>
                        </div>
                    </div>
                <?php } ?>
            </div>
