            ...
            <?php foreach ($arResult["ITEMS"] as $arItem) { ?>
                ...
                if ($arProperties['PICTURES']['VALUE'][0]) {
                    foreach ($arProperties['PICTURES']['VALUE'] as $imgId) {
                        $arImages[] = CFile::ResizeImageGet($imgId, ['width' => 395, 'height' => 330], BX_RESIZE_IMAGE_EXACT, true);
                    }
                }
                ?>

                <div class="section_product <?/* ${(object.special)?'--special':''} */?>" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
                    <button class="share">
                    ...
                    <div class="section__product-slider slider" id="product<?= $arItem['ID']; ?>slider" style="z-index: 1;">
                    ...
                    <div class="section_product_content">
                        ...
                        <a href="<?= $arItem['DETAIL_PAGE_URL']; ?>" class="title"><?= $arItem['NAME']; ?> <div class="size"><?= $arProperties['SQUARE_ALL']['VALUE']; ?> м<sup>2</sup></div></a>
                    ...
                    <div class="section_product_footer">
                        <button data-item-id="<?= $arItem['ID']?>" onclick='return setfav(this)' id="add_fav_<?= $arItem['ID']?>" class="favorite "> <!-- ${id_coockies_class} -->
                        ...
                        <a href="<?= $arItem['DETAIL_PAGE_URL']; ?>" class="price"><span><?= $arProperties['PRICE']['VALUE'] ?> <svg class="ruble"><use xlink:href="#Rouble"></use></svg></span><span>Подробнее</span></a>
                    </div>
                </div>
            <?php } ?>
                ...
                <?php foreach ($arResult["ITEMS"] as $arItem) {
                    ...
                    <div class="section_product"
                        ...
                        <div class="section_product_footer">
                            ...
                            <a href="<?= $arItem['DETAIL_PAGE_URL']; ?>" class="price"><span><?= $arProperties['PRICE']['VALUE']; ?> <svg class="ruble" fill="#4B4A4A"><use xlink:href="#Rouble"></use></svg></span><span>Подробнее</span></a>
                        </div>
                    </div>
                <?php } ?>
