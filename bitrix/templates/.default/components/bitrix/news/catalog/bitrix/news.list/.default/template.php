...
<section class="section catalog mb-3">
    <div class="wrapper">
        <div class="section__content-changer g-flex-column" id="slider_buildings">
            ...
            <div class="section__content-tabs changeTemplate">
                <div data-t="table" class="section__content-tab <? if ($arParams['TEMPLATE'] != 'map') : echo 'active'; endif; ?>">
                    Списком
                </div>
                <div data-t="map" class="section__content-tab <? if ($arParams['TEMPLATE'] == 'map') : echo 'active'; endif; ?>">
                    На карте
                </div>
            </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA3_b3EhD0YXwMp0q8DObsfavvJTbJ4M7I&callback=initGoogleMap"
        async defer></script>