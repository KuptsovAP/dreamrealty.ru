...
?>
    ...
    <section class="section advantages-page grayHalfBG">
        <div class="wrapper">
            ...
            <div class="section__advantages--full g-flex-wrap g-flex-between --mgt180">
                ...
                <a href="#advant_pop-up2" class="section__advantage --phm120 g-flex-column g-flex-justify-end --bg-cover-xs" style="background-image: url(/html/assets/img/illustrations/blue/02.1.svg);">
                ...
                <div class="section__content-slider slider">
                    ...
                    <div class="section__content-slide">
                        ...
                        <div class="section__content-changer g-flex-column" id="form">
                            <div class="section__content-tabs g-flex-between center g-flex-align-center --mgb60">
                                <div class="section__content-tab active">
                                    Жилая
                                </div>
                                <div class="section__content-tab">
                    ...
                    <div class="section__content-slide">
                        ...
                        <form class="g-flex-wrap g-flex-between g-flex-align-center --mgt30">
                            <h3>Выбрать <span class="--lightBlue">юриста по недвижимости</span></h3>
                            <label>
                                <input type="text" placeholder="Имя*" required>
                            </label>
                            <label>
                    ...
                    <div class="section__content-slide">
                        ...
                        <form class="g-flex-wrap g-flex-between g-flex-align-center --mgt30">
                            <h3>Разместить <span class="--lightBlue">объект в рекламу</span></h3>
                            <label>
                                <input type="text" placeholder="Имя*" required>
                            </label>
                            <label>
    ...
    <section class="section how-it-works">
        <div class="wrapper">
            <h2 class="section__title --mgb20">хотите узнать, <span class="--lightBlue">как мы работаем?</span></h2>

            <div class="section__catalog-change g-flex-between g-flex-align-stretch">
                <a href="/rent/" class="section__catalog-change_item section__catalog-change_item--notext g-flex-align-center g-flex-justify-start">
                    <svg class="icon" style="max-width: 200px;">
                        <use xlink:href="#ResidentialRealEstate"></use>
                    </svg>
                    Сдать
                </a>
                <a href="/rentTo/" class="section__catalog-change_item section__catalog-change_item--notext g-flex-align-center g-flex-justify-start">
                    <svg class="icon" style="max-width: 200px;">
    ...
    <!-- Попросили удалить этот блок, я скрыл и оставил его, если он дожил до бэкэнда удалите его -->
    <section class="section how-it-works"  style="display: none">
        <div class="wrapper">
            <h2 class="section__title --mgb20">хотите узнать, <span class="--lightBlue">как мы будем искать для вас недвижимость в аренду?</span></h2>
            <p class="section__descriptor descriptor --mgb60">Процессом аренды будут заниматься минимум два специалиста</p>
                ...
                <div class="section__content-slider slider">
                    ...
                    <div class="section__content-slide">
                        <div class="section__content-advantages w25per g-flex-wrap g-flex-between g-flex-align-start">
                            ...
                            <div class="section__content-advantage g-flex-column g-flex-align-start">
                                <img loading="lazy" src="/html/assets/svg/Conversation--lightBlue.svg" alt="">
                        ...
                        <a href="/team/" target="_blank" class="section__edge-button wow fadeInLeft  g-flex-align-center --mgt60 --mgb90">
                            <div class="arrow g-flex-align-center g-flex-justify-center">
                                <svg class="icon">
                                    <use xlink:href="#ArrowSquare"></use>
                                </svg>
                ...
                <section class="section differences">
                    <div class="wrapper">
                        ...
                        <form class="g-flex-wrap g-flex-between g-flex-align-center full-width --key">
                            ...
                            <label class="inputCheckbox">
                                <input type="checkbox" required checked>
                                <span>Нажимая на кнопку "Заказать оценку", вы даете согласие на обработку персональных данных</span>
                            </label>
                        </form>
                    </div>
                </section>
            ...
            <div class="content wrapper">
                ...
                <section class="section">
                    <div class="wrapper">
                        ...
                        <form class="g-flex-wrap g-flex-between g-flex-align-center full-width" id="download_3up--key">
